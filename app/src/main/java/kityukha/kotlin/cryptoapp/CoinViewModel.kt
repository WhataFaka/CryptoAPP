...
import kityukha.kotlin.cryptoapp.api.ApiFactory
import kityukha.kotlin.cryptoapp.database.AppDatabase
...
class CoinViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun loadData() {
        val disposable = ApiFactory.apiService.getTopCoinsInfo(limit = 15)
